	...
	buildFrontendViews:function(){	
		...
		for(var i =0 ; i<this._config.views.length; i++){			
			...
			for (var key in viewConfig.fields){
				...
				field.showField = (viewConfig.type != 'addForm');
			...
			switch(viewConfig.type){
				...
				case "detailFormView":
					...
					break;
				case "nestView":
					var viewTemplateFile = path.resolve(__dirname,"../../../templates/module/frontend/view/nestView-template.js")
					var viewJadeTemplateFile = path.resolve(__dirname,"../../../templates/module/frontend/template/nestView-template.jade")
					break;
				...
				case "nestDetailFormView":
					...
					break;
				case "nestGridView":
					var viewTemplateFile = path.resolve(__dirname,"../../../templates/module/frontend/view/nestGridView-template.js")
					var viewJadeTemplateFile = path.resolve(__dirname,"../../../templates/module/frontend/template/nestGridView-template.jade")
					break;	
				default:
					var viewTemplateFile = path.resolve(__dirname,"../../../templates/module/frontend/view/formView-template.js")
					var viewJadeTemplateFile = path.resolve(__dirname,"../../../templates/module/frontend/template/formView-template.jade")
