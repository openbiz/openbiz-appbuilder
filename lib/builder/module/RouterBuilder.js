...
module.exports={
	buildBackendRouter:function(){
		...
		if(fs.existsSync(file) && this._config.override==false) return this;
	...
	buildFrontendRouter:function(){
		var file = path.join(this._config.output,"ui","modules",this._config.name,"router.js");
		if(fs.existsSync(file) && this._config.override==false) return this;
		var data = {
	...
	buildFrontendMain:function(){
		var file = path.join(this._config.output,"ui","modules",this._config.name,"main.js");
		if(fs.existsSync(file) && this._config.override==false) return this;
		var template = _.template(fs.readFileSync(
