...
module.exports={
	buildFrontendViews:function(){	
		for(var i =0 ; i<this._config.views.length; i++){			
			...
			var file = path.join(this._config.output,"ui","modules",this._config.name,"views",viewConfig.name+".js");
			if(fs.existsSync(file) && this._config.override==false) continue;
			...
			var file = path.join(this._config.output,"ui","templates",this._config.name,viewConfig.name+".jade");
			if(fs.existsSync(file) && this._config.override==false) continue;
	    	...
	    	var html = fn();
	    	var file = path.join(this._config.output,"ui","templates",this._config.name,viewConfig.name+".html");
